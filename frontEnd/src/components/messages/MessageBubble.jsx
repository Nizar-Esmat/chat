...
function MessageBubble({ message, isOwnMessage, onEdit, onDelete }) {
    const bubbleStyles = `relative max-w-xs md:max-w-md px-4 py-3 rounded-2xl shadow-lg border backdrop-blur-sm transition-all duration-200 hover:shadow-xl hover:-translate-y-0.5 ${isOwnMessage
